...
def LeNet(input_x, input_y,
    ...
    bn_layer = norm_layer(conv_layer_0.output())

    
    pooling_layer_0 = max_pooling_layer(input_x=bn_layer.output(),
    ...
    bn_layer2 = norm_layer(conv_layer_1.output())

    
    pooling_layer_1 = max_pooling_layer(input_x=bn_layer2.output(),
    ...
    #second bn Layer
    #bn_layer_2 = norm_layer(fc_layer_1.output())
    ...
    with tf.Session() as sess:
        ...
        for epc in range(epoch):
            ...
            for itr in range(iters):
                ...
                data_augment = ImageGenerator(training_batch_x, training_batch_y) 
